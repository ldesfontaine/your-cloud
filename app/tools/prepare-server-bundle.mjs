// Prépare le lot serveur que le paquet Debian de l'App embarque, et
...
// avant le build de l'App, qui le re-vérifie au lieu de le croire.
//
...
// Debian de l'App livre le lot (`bundle.linux.deb.files`), et le `.msi`
...
const stagedDirectory = resolve(appRoot, "src-tauri", "server-bundle");
...
// refus, pas un lot de secours : un paquet de App sans lot signé serait un
