export type AppLockState = "uninitialized" | "locked" | "unlocked";
...
export type MachineView = {
  ...
  /// Ce que l'App doit signer : le successeur exact de cette position.
  /// Elle vient de ce que la machine a elle-même rapporté, jamais d’une
  /// supposition de cette App.
...
// identiques pour toutes les lignes, et l'App les tient du contexte de la
...
// `schema_version` : l'App écrit la seule version qu’elle connaît, et un
...
// sans sa phrase est un trou que le contrat de source rougit : l'App ne
...
// qu’un oubli de cette projection : rien entre le Controller et l'App ne
...
/// Un dispatch tel que l'App le relit. Les états sont ceux du contrat, et
