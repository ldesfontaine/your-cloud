...
/// small enough for the App to always display the whole document. The two
...
impl ServiceDefinitionDocument {
    ...
    /// The App reads it to say, before a freeze, that approving a deployment
...
mod tests {
    ...
    /// transport or an App that reordered a list would be handing an
