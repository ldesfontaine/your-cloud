...
//!
//! An approval crosses a machine the App does not control: the Controller
...
//! and no key type. It turns a validated envelope into bytes; the App core
...
/// signature of the pairing, session or recovery transcripts of the App,
...
pub struct ApprovalEnvelopeV1 {
    ...
    /// signers, so this is what separates a rotated App from a forged one.
...
mod tests {
    ...
    /// read only`, and of its rollback, `no change to roll back`. The App
