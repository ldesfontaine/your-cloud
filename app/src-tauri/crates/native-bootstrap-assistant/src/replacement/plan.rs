...
//! is [`Succession`]'s; that one App is bound to it freshly is
...
pub enum Step {
    ...
    /// Bind one App to it, freshly, for this infrastructure only, importing
    ...
    /// Archive the old association in the App, revoking its device and its
