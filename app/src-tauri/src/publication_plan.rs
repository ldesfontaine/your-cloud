...
pub enum PublicationPlanError {
    ...
    UnverifiedPlan,
    #[error("the plan names another infrastructure than this App is associated to")]
...
impl PresentedPublicationPlan {
    ...
    /// Services view made the App hold a definition beside a plan; it does
    ...
    /// meet in this App is the day it belongs here.
    ...
    pub fn sign(
        ...
        // an approval can only ever name the infrastructure this App is
...
mod tests {
    ...
    /// A plan is approved by the App of its own infrastructure or by none.
    #[test]
