...
/// un plus long serait un bail que la montre couperait sans que l'App
/// sache pourquoi.
///
...
/// pas *revenir* de la fenêtre native à l'App, si bien que 8,7 s est un
...
pub struct PlanConsentSessionView {
    ...
    /// this App has held against the pair.
