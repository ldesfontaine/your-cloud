...
$proofScript = Resolve-Path (Join-Path $PSScriptRoot "app-windows-ci.ps1")
$tokens = $null
$errors = $null
...
$appPath = "C:\Program Files\Your Cloud\your-cloud-app.exe"
$driverPath = "C:\tools\tauri-driver.exe"
$trackedPaths = @($appPath, $driverPath)
...
$boundedChild = Join-Path $boundedRoot "AppData/Roaming/fr.your-cloud.app"
...
$uiProofScript = Resolve-Path (Join-Path $PSScriptRoot "app-windows-ui-proof.py")
