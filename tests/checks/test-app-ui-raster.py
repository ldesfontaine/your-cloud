#!/usr/bin/env python3
"""Hostile standard-library checks for the installed App UI proof oracles."""
...
PROOF_PATH = pathlib.Path(__file__).with_name("app-windows-ui-proof.py")
SPEC = importlib.util.spec_from_file_location("app_ui_proof", PROOF_PATH)
if SPEC is None or SPEC.loader is None:
    raise AssertionError("App UI proof module could not be loaded")
