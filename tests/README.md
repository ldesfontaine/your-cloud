...
| [`lab/v0.1.1/`](lab/v0.1.1/) | le moteur des services utilisateur prouvé une fois : une application synthétique construite pour l'exercer entièrement, son image servie par digest depuis une origine de la course, la troisième porte posée à côté d'un profil livré, les deux genres de route, les archives, les valeurs générées et les refus | topologie KVM/libvirt `quick` pilotée par `labctl` | codes de sortie du harnais, assertions machine et lectures depuis l'extérieur des machines |
