...
| `V1-APP-ACCESS` | Séparation Console–Controller, accès privé à la V1 et cible d'administration privée par appareil, indépendante des services publiés | `docs/objectifs/v1/README.md` | `CONTEXT.md`, `docs/projet/CAP.md`, `docs/objectifs/v1/ROADMAP.md`, `docs/architecture/ANATOMIE.md`, `docs/architecture/CHAINE-D-OBSERVATION.md` |
