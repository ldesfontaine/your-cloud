//! Binding this Console to this Controller, freshly and for one infrastructure.
//!
...
/// What the Controller offered the Console.
...
/// The proof that one Console was bound to one Controller for one
